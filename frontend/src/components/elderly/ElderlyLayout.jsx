  ...
  const sidebarContent = (
    ...
    >
      ...
      >
        ...
        />
        <Box sx={{ color: "#8ab9b6", fontSize: 18, fontWeight: 800 }}>
          Holder
        </Box>
      </Box>
        ...
        >
          <Toolbar sx={{ justifyContent: "space-between" }}>
            <IconButton
              ...
              sx={{ mr: 2, color: isDarkMode ? "#9ba3b3" : "#253044" }}
            >
              <MenuIcon />
            </IconButton>
            <Typography variant="h6" fontWeight={800} sx={{ color: "#df9aa4" }}>
              HOLDER
            </Typography>
            <IconButton
              onClick={onToggleTheme}
              sx={{ color: isDarkMode ? "#9ba3b3" : "#253044" }}
            >
              {isDarkMode ? (
